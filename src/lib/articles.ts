...
export const articlesData: Article[] = [
  {
    title: 'Tutoren-Fußballturnier der 5. und 6. Klassen',
    source: 'König-Karlmann-Gymnasium',
    organizationSlug: 'kkg',
    url: 'https://www.koenig-karlmann-gymnasium.de/news/tutoren-fussballturnier-der-5-und-6-klassen/',
    date: '2026-07-28',
    description: 'Beim Fußballturnier der Tutoren habe ich mit dem Technikteam für die Musik gesorgt.',
  },
  {
    title: 'Bericht zum Jugendopen 2026',
    source: 'Schachklub Töging e. V.',
    organizationSlug: 'schachklub-toeging',
    url: 'https://schachklub-toeging.de/jugendopen-2026-2/',
    date: '2026-07-19',
    description: 'Beim Jugendopen des Schachklub Töging habe ich in der Altersklasse U18 den 3. Platz belegt.',
  },
  {
    title: 'Lesenacht der Tutoren für die 5. Jahrgangsstufe',
    source: 'König-Karlmann-Gymnasium',
    organizationSlug: 'kkg',
    url: 'https://www.koenig-karlmann-gymnasium.de/news/lesenacht-der-tutoren-fuer-die-5-jahrgangsstufe/',
    date: '2026-07-01',
    description: 'Die Tutoren haben eine Lesenacht für die 5. Jahrgangsstufe veranstaltet – ich war als Tutor dabei.',
  },
  {
    title: 'TuS Töging: Judoabteilung unter neuer Leitung',
    source: 'Passauer Neue Presse',
    organizationSlug: 'pnp',
    url: 'https://www.pnp.de/lokales/landkreis-altoetting/tus-toeging-judoabteilung-unter-neuer-leitung-21031966',
    date: '2026-04-28',
    description: 'Die PNP berichtet über die neue Leitung der Judoabteilung – Vinzenz und ich sind 2026 als Schriftführer dabei.',
  },
  {
    title: 'Neuer JD-Kampfrichter beim Bayerischen Judo-Verband',
    source: 'Facebook',
    organizationSlug: 'facebook',
    url: 'https://www.facebook.com/permalink.php?story_fbid=pfbid0qBxMNBkuouw2BfijdfrJX2SudKzoKahZdd9Uioh8gmqA9qZtXetM12u59y92SG4wl&id=100014862738691',
    date: '2026-03-29',
    description: 'Facebook-Beitrag, dass ich seit dem 29. März 2026 JD-Kampfrichter beim Bayerischen Judo-Verband bin.',
  },
  {
    title: 'Andreas Bichlmaier neuer Abteilungsleiter der Judoabteilung',
    source: 'TuS Töging',
    organizationSlug: 'tus-toeging',
    url: 'https://www.tustoeging.de/neuigkeiten.htm?n=174',
    date: '2026-04-02',
    description: 'Bericht über die Jahreshauptversammlung der Judoabteilung am 02.04.2026 – Vinzenz und ich wurden als Schriftführer wiedergewählt.',
  },
  {
  ...
  {
    title: 'Erneuter Erfolg bei crossmedia',
    source: 'König-Karlmann-Gymnasium',
    organizationSlug: 'kkg',
    url: 'https://www.koenig-karlmann-gymnasium.de/news/erneuter-erfolg-bei-crossmedia/',
    date: '2025-11-27',
    description: 'Das König-Karlmann-Gymnasium berichtet über den erneuten Erfolg beim Crossmedia‑Wettbewerb, bei dem Notio als Projekt des KKG ausgezeichnet wurde.',
  },
];
