...
export default function ProjectCard({ project, headingLevel = 'h2' }: { project: Project; headingLevel?: 'h2' | 'h3' }) {
  const { t } = useI18n();
  ...
  return <article className="work-tile">
    ...
    <Heading><Link href={`/projects/${project.slug}`}>{project.title}</Link></Heading>
